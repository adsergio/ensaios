            ...
            <div class="col-lg-4 col-6 text-left">
                <form action="lista-produtos.php" method="get">
                    <div class="input-group">
                        <input type="text" name="txtBuscar" class="form-control" placeholder="Buscar produtos?"value="<?php echo @$_GET['txtBuscar'] ?>">
                        <div class="input-group-append">
                            <button type="submit" class="btn bg-transparent text-primary input-group-text">
        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a class="btn d-flex align-items-center justify-content-between bg-dark w-100" data-toggle="collapse" href="#navbar-vertical" style="height: 65px; padding: 0 30px;">
                    <h6 class="text-white m-0"><i class="fa fa-bars mr-2"></i>DEPARTAMENTOS</h6>
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-dark" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                       ...
                       <?php 
                       $query = $pdo->query("SELECT * FROM categorias order by nome ");
                       ...
                       for ($i=0; $i < count($res); $i++) { 
                        ...
                        <a href="sub-categoria-de-<?php echo $nome_url ?>" class="nav-item nav-link"><?php echo $nome ?></a></h5></a>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="categorias.php" class="nav-item nav-link">DEPARTAMENTOS</a> 
                            <a href="sub-categorias.php" class="nav-item nav-link">SUB-DEPARTAMENTOS</a>                            
