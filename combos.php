 ...
 ?>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">LISTA DE COMBOS</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <!-- Promotion Start -->
          ...
          <div class="col-10"><div class="row px-xl-5 pb-3">
               ...
               <?php 
                       $query = $pdo->query("SELECT * FROM combos order by id LIMIT $limite, $itens_por_pagina ");
                       $res = $query->fetchAll(PDO::FETCH_ASSOC);
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4 text-center">
                    <div class="product__discount__item__pic product-img position-relative overflow-hidden">
                        <img class="img-fluid w-75" src="img/combos/<?php echo $imagem ?>"  alt="">
                        <!-- Badge de desconto -->
                    ...
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate-1 text-break" href="sub-categoria-de-<?php echo $nome_url ?>">
    <?php echo $nome ?>
</a>
