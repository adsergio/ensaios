...
if($url[1] == 'localhost/'){
    $url_loja = "http://$_SERVER[HTTP_HOST]/dlabor2/";
}
...
//verificar config
 $res = $pdo->query("SELECT * FROM config where id = 0"); 
    ...
    if(@count($dados_res) == 0){
       $pdo->query("INSERT into config SET id = '0', nome_loja = 'Boutique Freitas', telefone_loja = '(31) 3333-3333', email_loja = 'admin@hotmail.com', whatsapp = '(31) 97527-5084', texto_destaque = 'Aproveite as nossas Promoções!', endereco_loja = 'Rua Alameda Campos, Número 50, Bairro Centro, Belo Horizonte - MG - CEP 31535-800', itens_por_pagina = '6', cep_origem = '30512-660', comprimento_caixa = '30', largura_caixa = '20', altura_caixa = '20', diametro_caixa = '25', mao_propria = 'N', formato_frete = '1', valor_declarado = '0', aviso_recebimento = 'N', total_cartoes_troca = '10', valor_cupom_cartao = '20', dias_uso_cupom = '7', nivel_estoque = '5', dias_limpar_carrinho = '2', retirada_local = 'Sim', nota_minima = '3', enviar_total_emails = '480', intervalo_envio_email = '70', pagar_entrega = 'Sim', relatorio_pdf = 'Sim', rodape_relatorios = 'Desenvolvido por Hugo Vasconcelos do Portal Hugo Cursos!!', logo = 'logo.png', favicon = 'favicon.png', api_pix = 'Sim'");
    }else{
