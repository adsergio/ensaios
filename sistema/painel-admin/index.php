...
<html lang="en">
    ...
    <head>
        ...
        <meta name="author" content="Sérgio Silva">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                    ...
                    <div class="sidebar-brand-text mx-3">NOME DA LOJA</div>
                </a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu8 ?>">Tipos de Envio</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu9 ?>">Caracteristicas</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu4 ?>">Promoções Banner</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu10 ?>">Combos</a>
...
<!-- Script Modal Editar perfil usuário -->
