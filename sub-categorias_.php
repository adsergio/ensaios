    ...
    <div class="container-fluid pt-5">
    	...
    	<div class="row">
    		...
    		<div class="col-lg-9 col-md-7">
    			...
    			<h5 class="py-2">SUB DEPARTAMENTOS</h5>
    			<div class="col-sm-9"><div class="row px-xl-5 pb-3">
    						...
    						<a class="text-decoration-none" href="sub-categoria-de-<?php echo $nome_url ?>">
    							<div class="cat-item img-zoom d-flex align-items-center mb-4">
    								...
    								<div class="flex-fill pl-3">
    									<h6><?php echo $nome ?> </h6>
    									<small class="text-body"><h3> <?php echo $itens ?> Itens</h3> </small>
    								</div>
    							</div>
    						</a>
    					</div>
